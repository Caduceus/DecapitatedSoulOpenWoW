...
public:
	...
	void SendDefaultMenu(Player* pPlayer, Creature* pCreature, uint32 uiAction)
	{
		...
		case 1000: //Profession
			pPlayer->ADD_GOSSIP_ITEM(5, "75 points in Alchemy.", GOSSIP_SENDER_MAIN, 1001);
			pPlayer->ADD_GOSSIP_ITEM(5, "75 points in Blacksmithing.", GOSSIP_SENDER_MAIN, 1002);
			pPlayer->ADD_GOSSIP_ITEM(5, "75 points in Enchanting.", GOSSIP_SENDER_MAIN, 1003);
			pPlayer->ADD_GOSSIP_ITEM(5, "75 points in Engineering.", GOSSIP_SENDER_MAIN, 1004);
			pPlayer->ADD_GOSSIP_ITEM(5, "75 points in Herbalism.", GOSSIP_SENDER_MAIN, 1005);
			pPlayer->ADD_GOSSIP_ITEM(5, "75 points in Inscription.", GOSSIP_SENDER_MAIN, 1006);
			pPlayer->ADD_GOSSIP_ITEM(5, "75 points in Jewelcrafting.", GOSSIP_SENDER_MAIN, 1007);
			pPlayer->ADD_GOSSIP_ITEM(5, "75 points in Leatherworking.", GOSSIP_SENDER_MAIN, 1008);
			pPlayer->ADD_GOSSIP_ITEM(5, "75 points in Mining.", GOSSIP_SENDER_MAIN, 1009);
			pPlayer->ADD_GOSSIP_ITEM(5, "75 points in Skinning.", GOSSIP_SENDER_MAIN, 1010);
			pPlayer->ADD_GOSSIP_ITEM(5, "75 points in Tailoring.", GOSSIP_SENDER_MAIN, 1011);
		...
		case 3000: //Back To Main Menu
			...
			if (pPlayer->GetTeam() == ALLIANCE)
			{
				// Check config if "Professions" is enabled or not
				if (EnableProfessions)
					pPlayer->ADD_GOSSIP_ITEM(7, "Primary Professions ->", GOSSIP_SENDER_MAIN, 1000);
				// Check config if "Secondary Skills" is enabled or not
				if (EnableSecondarySkills)
					pPlayer->ADD_GOSSIP_ITEM(7, "Secondary professions ->", GOSSIP_SENDER_MAIN, 2000);
			}
			else // Main Menu for Horde
			{
				// Check config if "Professions" is enabled or not
