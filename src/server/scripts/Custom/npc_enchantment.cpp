...
public:
	...
	bool OnGossipSelect(Player* player, Creature* creature, uint32 /*sender*/, uint32 action)
	{
		...
		case 0: //Welcome message on click
			player->GetSession()->SendAreaTriggerMessage("|cffFF0000Welcome to Decapitated Soul, feel free to enchant your gear on us! Please, support the server in anyway you can. Be it Voting, Donating, or Recruiting!");
